...
class Config(object):
	...
	STREAMTAPE_API_PASS = os.environ.get("STREAMTAPE_API_PASS", "devashi@123A")
	STREAMTAPE_API_USERNAME = os.environ.get("STREAMTAPE_API_USERNAME", "ddbambhava8182@gmail.com")
